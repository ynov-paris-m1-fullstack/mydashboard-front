...
export default async function Home() {
  ...
  return (
    <div className={styles.stats__grid}>
      <StatCard label="Total sales" value={stats.totalSales} icon={salesIcon} />
      <StatCard label="Quantities sold" value={stats.totalQuantity} icon={salesIcon} />
      <StatCard label="Total order" value={stats.totalOrder} icon={salesIcon} />
      <StatCard label="Average sales" value={stats.averageSaleAmount} icon={salesIcon} />
    </div>
  );
}
